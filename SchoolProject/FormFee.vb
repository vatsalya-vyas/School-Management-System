...
Public Class FormFee
    ...
    Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            con.Open()
            cmd = New OleDbCommand("Insert into [tblFee]([AdmissionNo],[StudentName],[Class],[PayMode],[Amount],[Date]) values ('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "','" & TextBox6.Text & "')", con)
